...
!
!           ROUTINES FOR LINEAR TRIBLOCK COPOLYMERS 
!
!cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
!
module Molecule_Triblock_Copolymer
!
  use Global
  use Propagate
!
...
!
  ...
  integer, parameter  :: block_number = 3
!
  type triblock_copolymer
    integer                                   :: label
  ...
  end type triblock_copolymer
!
  public :: triblock_copolymer
  public :: Initialize_Triblock
  public :: Propagate_Triblock
!
contains
!
!cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
...
!cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
!
  subroutine Initialize_Triblock(copolymer,label,monomer_type,block_length, &
                                ensemble,rho,mu)
!
   implicit none
...
!
   type(triblock_copolymer), intent(out):: copolymer
!
...
!
   print*, 'Triblock Copolymer ', copolymer%label, ' is initialized (', &
...
!
  end subroutine Initialize_Triblock
!
!cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
!
...
!
!
  subroutine Propagate_Triblock(copolymer,expfield)
!
    implicit none
...
!
  ...
  end subroutine Propagate_Triblock
!
!cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
!
end module Molecule_Triblock_Copolymer
