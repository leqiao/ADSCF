...
!
    ...
    interaction_energy = dvol*sum(local_interaction_energy)/monomer_volume(0)
!   --- 1/monomer_volume(0): density of pure solvent is reference density.
...
!
    do component = 1,components
      ...
      field(:,:,:,component) = field(:,:,:,component) &
           * monomer_volume(component)/monomer_volume(0)
    end do
